...
";
        ...
        public string Answer {
            get {
                return "The sum of the numbers on the diagonals in a 1001 by 1001 spiral is {0}"
        ...
        public double Solve() {
            int n = 500;
            return ((16 * Math.Pow(n, 3) + 26 * n) / 3 + 10 * Math.Pow(n, 2)) + 1;
        }
    }
}
